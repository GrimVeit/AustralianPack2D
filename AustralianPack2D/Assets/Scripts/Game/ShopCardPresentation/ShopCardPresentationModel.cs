...
public class ShopCardPresentationModel
{
    private readonly ICardBoxBuyListener _cardBoxBuyListener;

    private readonly IStoreCardProvider _storeCardProvider;

    public ShopCardPresentationModel(ICardBoxBuyListener cardBoxBuyListener, IStoreCardProvider storeCardProvider, IStoreCardListener storeCardListener)
    {
