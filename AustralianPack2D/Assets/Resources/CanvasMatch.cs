...
{
    [SerializeField] private float maxKoef;
    [SerializeField] private float minKoef;
    ...
    void ApplyMatch()
    {
        ...
        float baseRatio = 1080f / 1920f; // 16:9
        ...
        if (current > baseRatio)
        {
            ...
            t = (current - baseRatio) / (maxKoef - baseRatio); // примерная верхняя граница
            //t = Mathf.Clamp01(t);
        ...
        else
        {
            ...
            t = (baseRatio - current) / (minKoef - baseRatio); // примерная нижняя граница
            //t = Mathf.Clamp01(t);
